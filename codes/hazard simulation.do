...
foreach s in S1 S2 S3 S4{
	...
	glm fweight min min610b min35b min12b min12a min35a min610a min1115a min1620a bin* if remain>0 & wagcat~=161 & wagcat ~= 0, link(cloglog) family(binomial remain) 
    ...
    * Export the standard errors below the coefficients
	...
	reg cloglog_hazard min min610b min35b min12b min12a min35a min610a min1115a min1620a bin* if remain>0 & wagcat ~= 0 & wagcat ~= 161
